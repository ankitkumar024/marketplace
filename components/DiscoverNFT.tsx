...
const DiscoverNFT = () => {
    return (
        <div id='marketplace' className='pt-[8rem] w-auto lg:pl-[90px] lg:pr-[90px]'>
            ...
            <div className="nft-cards pt-4 grid grid-cols-1 md:grid-cols-3 gap-6 w-max-[1500px] items-center justify-center">
                {discoverNFTS.map((items) => (
                    <div key={items.id} className='bg-black rounded-3xl w-full'>
                        <img className='w-full' src={items.img} alt="" />
                        <h1 className='text-[18px] font-semibold p-4 md:text-[] md:pt-8 md:pb-8'>{items.title}</h1>
